...
Процедура СоздатьСтатистическуюКарточкуАвтора(Форма, АвтораУИД, ИмяАвтора, Количество, ВсегоПроизведений) Экспорт
	...
	ШрифтКоличество					= Новый Шрифт("Verdana", 11, Ложь);
...
#Область ДобавлениеРеквизитаФормыИндикатор
...
#Область ДобавлениеЭлементовФормыКоличество
	...
	ЭлементФормыДекорацияКоличество 				= Форма.Элементы.Добавить(ИмяЭлементаКоличество + "_", Тип("ДекорацияФормы"), ГруппаФормыИндикация);
	ЭлементФормыДекорацияКоличество.Вид 			= ВидДекорацииФормы.Надпись;
	ЭлементФормыДекорацияКоличество.Заголовок 		= Количество;
